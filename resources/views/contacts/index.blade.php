                ...
                <div class="col-12">
                    <div class="card card-background card-background-after-none align-items-start mt-4 mb-5">
                        ...
                        <div class="card-body text-start p-4 w-100">
                            <h3 class="text-white mb-2">Boost your productivity 🔥</h3>
                            <p class="mb-4 font-weight-semibold">
                                Add your contact number and start to send whatsapp messages!
                            </p>
                            <button type="button"
                    ...
                    <div class="card border shadow-xs mb-4">
                        <div class="card-header border-bottom pb-0">
                            <div class="d-sm-flex align-items-center">
                                <div>
                                    <h6 class="font-weight-semibold text-lg mb-0">Contact list</h6>
                                    <p class="text-sm">See information about all contacts</p>
                                </div>
                                <div class="ms-auto d-flex">
                                    ...
                                    <div class="modal fade" id="modalContact" tabindex="-1"
                                        aria-labelledby="modalContactlabel" aria-hidden="true"
                                        data-bs-backdrop="static">
                                        <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
                                            <form class="modal-content" role="form" method="POST"
                                                action="/contacts/add">@csrf
                                                <div class="modal-header">
                                                    <h5 class="modal-title" id="modalContactlabel">Modal title</h5>
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <div class="mb-3">
                                                        <input type="text" maxlength="12" id="phone"
                                                            name="phone" class="form-control"
                                                            placeholder="237699887766" value="{{ old('phone') }}"
                                                            aria-label="Email" aria-describedby="phone-addon">
                                                        @error('phone')
                                                            <span class="text-danger text-sm">{{ $message }}</span>
                                                        @enderror
                                                    </div>
                                        ...
                                        @foreach ($contacts as $contact)
                                            <tr>
                                                ...
                                                <td class="align-middle text-center">
                                                    <span
                                                        class="text-secondary text-sm font-weight-normal">{{ $contact->created_at }}</span>
                                                </td>
                                                <td class="align-middle">
                                                    ...
                                                    <a href="contacts-delete/{{$contact->id}}"><i class="fas fa-trash" aria-hidden="true"></i></a>
                                                </td>
                                            </tr>
                                        @endforeach
                                    </tbody>
