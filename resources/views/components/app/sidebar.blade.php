<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 bg-slate-900 fixed-start " id="sidenav-main">
    <div class="sidenav-header">
        ...
        <a class="navbar-brand d-flex align-items-center m-0"
            href="/">
            <span class="font-weight-bold text-lg">SAB Concept</span>
        </a>
    </div>
    <div class="collapse navbar-collapse h-75 px-4 w-auto " id="sidenav-collapse-main">
        <ul class="navbar-nav">
            <li class="nav-item">
            ...
            <li class="nav-item {{auth()->user()->is_admin == true? 'd-none':''}}">
                <a class="nav-link  {{ is_current_route('contacts') ? 'active' : '' }}" href="{{ route('contacts') }}">
                    <div
                        class="icon icon-shape icon-sm px-0 text-center d-flex align-items-center justify-content-center">
                        <svg width="30px" height="30px" viewBox="0 0 48 48" version="1.1"
                            xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
            ...
            <li class="nav-item border-start my-0 pt-2 {{auth()->user()->is_admin == false? 'd-none':''}}">
