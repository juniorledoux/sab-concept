<nav
    ...
    <div class="container-fluid px-1">
        <a href="javascript:;" class="avatar mb-0 avatar-sm rounded-circle mx-2" data-bs-toggle="tooltip"
            data-original-title="Audrey Love">
            <img alt="Image placeholder" src="../assets/logos/logo1.png" class="rounded-circle">
        </a>
        ...
        <div class="collapse navbar-collapse" id="navigation">
            ...
            <ul class="navbar-nav d-lg-block d-none">
                <li class="nav-item">
                    <a href="javascript:;" class="avatar mb-0 avatar-sm rounded-circle" data-bs-toggle="tooltip"
                        data-original-title="Audrey Love">
                        <img alt="Image placeholder" src="../assets/logos/logo2.jpeg" class="rounded-circle">
                    </a>
                </li>
            </ul> --}}
        </div>
