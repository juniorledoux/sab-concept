...
<head>
    ...
    <title>Sab-Concept</title>
    <meta content="" name="description">
    <meta content="" name="keywords">

    <!-- Favicons -->
    <link href="assets/logos/logo1.png" rel="icon">
...
<body>
    ...
    <header id="header" class="fixed-top d-flex align-items-center">
        <div class="container d-flex align-items-center justify-content-between">
            ...
            <div class="logo">
                <h1 class="text-light"><a href="/"><img alt="Image placeholder"
                            src="../assets/logos/logo1.png" class=""></a></h1>
    ...
    <footer id="footer">
        ...
        <div class="container py-4">
            <div class="copyright">
                &copy; Copyright <strong><span>SAB Concept</span></strong>. All Rights Reserved
            </div>
            <div class="credits">
                ...
                Designed by <a href="https://bootstrapmade.com/">Karbura</a>
            </div>
        </div>
    </footer><!-- End Footer -->
